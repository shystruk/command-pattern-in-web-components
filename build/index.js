...
var _find_your_job = __webpack_require__(3);

var _find_your_job2 = _interopRequireDefault(_find_your_job);

var _find_your_jobs = __webpack_require__(1);
...
var Find_Your_Job = function (_CustomElement2) {
    ...
    function Find_Your_Job() {
        ...
        _this.resource = Object.create(_find_your_job4.default);
        ...
        _this.selectorsOnChangeListener();
        _this.moreJobsClickListener();
        return _this;
    }

    _createClass(Find_Your_Job, [{
        key: 'selectorsOnChangeListener',
        value: function selectorsOnChangeListener() {
            var self = this;
            var selectElements = [this.shadowRoot.querySelector('.' + _find_your_job5.FIND_YOUR_JOB.SELECT_NAMES.DESCRIPTION), this.shadowRoot.querySelector('.' + _find_your_job5.FIND_YOUR_JOB.SELECT_NAMES.LOCATION), this.shadowRoot.querySelector('.' + _find_your_job5.FIND_YOUR_JOB.SELECT_NAMES.FULL_TIME)];
        ...
        value: function moreJobsClickListener() {
            var self = this;

            this.$moreJobsElement.onclick = function () {
                self.showLoader(true);

                self.resource.getMoreJobs().then(function (response) {
        ...
        value: function handleSelectOnChange(event) {
            ...
            this.resource.executeGetJobs(_find_your_jobs2.default.buildRequestConfig(target.className, target.value)).then(function (response) {
                _this2.hideShowMoreButton(response.showMore);
                _this2.showLoader(false);
                _this2[response.parser](response.jobs);
            });
        }
        ...
        value: function hideShowMoreButton(show) {
